...
- [.config](./.config)
  - [bash.d](./.config/bash.d)
    ...
    - [scripts](./.config/bash.d/scripts)
      - [p2p_chat_id](./.config/bash.d/scripts/p2p_chat_id)
  - [bat.d](./.config/bat.d)
  ...
  - [sh.d](./.config/sh.d)
    - [focus-events.sh](./.config/sh.d/focus-events.sh)
    ...
    - [scripts](./.config/sh.d/scripts)
      ...
      - [bug](./.config/sh.d/scripts/bug)
      - [clip2](./.config/sh.d/scripts/clip2)
      - [fingerprint](./.config/sh.d/scripts/fingerprint)
      - [from_epoch_to_date](./.config/sh.d/scripts/from_epoch_to_date)
      - [now](./.config/sh.d/scripts/now)
  - [zsh.d](./.config/zsh.d)
    - [autosuggestions.zsh](./.config/zsh.d/autosuggestions.zsh)
    - [cd.zsh](./.config/zsh.d/cd.zsh)
...
- [.vim](./.vim)
  ...
  - [plugin](./.vim/plugin)
    ...
    - [easy-alignrc.vim](./.vim/plugin/easy-alignrc.vim)
    ...
    - [sidewaysrc.vim](./.vim/plugin/sidewaysrc.vim)
    - [sneakrc.vim](./.vim/plugin/sneakrc.vim)
    - [statusline.vim](./.vim/plugin/statusline.vim)
    - [.statusline.vim.swp](./.vim/plugin/.statusline.vim.swp)
    - [vimgrep-rg.vim](./.vim/plugin/vimgrep-rg.vim)
